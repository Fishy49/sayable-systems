...
Sayable was **inspired by** the open-source [CoughDrop](https://github.com/CoughDropAAC/coughdrop)
project — specifically the *idea* that an AAC board is a grid of buttons that
either speak or navigate. **No CoughDrop code, text, or assets were copied.**
